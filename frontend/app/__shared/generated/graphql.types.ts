...
export type GetDevTokenAbiQuery = {
  __typename?: "Query";
  getDevTokenABI: string;
};
 ...
 * });
 */
export function useGetDevTokenAbiQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetDevTokenAbiQuery,
    GetDevTokenAbiQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>(
    GetDevTokenAbiDocument,
    options,
  );
}
export function useGetDevTokenAbiLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>(
    GetDevTokenAbiDocument,
    options,
  );
}
export function useGetDevTokenAbiSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
  ...
  return Apollo.useSuspenseQuery<
    GetDevTokenAbiQuery,
    GetDevTokenAbiQueryVariables
  >(GetDevTokenAbiDocument, options);
}
export type GetDevTokenAbiQueryHookResult = ReturnType<
  typeof useGetDevTokenAbiQuery
>;
export type GetDevTokenAbiLazyQueryHookResult = ReturnType<
  typeof useGetDevTokenAbiLazyQuery
>;
export type GetDevTokenAbiSuspenseQueryHookResult = ReturnType<
  typeof useGetDevTokenAbiSuspenseQuery
>;
export type GetDevTokenAbiQueryResult = Apollo.QueryResult<
  GetDevTokenAbiQuery,
  GetDevTokenAbiQueryVariables
>;
