...
export type Query = {
  __typename?: 'Query';
  getDevTokenABI: Scalars['String']['output'];
...
export type GetDevTokenAbiQueryVariables = Exact<{ [key: string]: never; }>;


export type GetDevTokenAbiQuery = { __typename?: 'Query', getDevTokenABI: string };
...
export const GetDevTokenAbiDocument = gql`
    query getDevTokenABI {
  getDevTokenABI
}
    `;

/**
 * __useGetDevTokenAbiQuery__
 *
 * To run a query within a React component, call `useGetDevTokenAbiQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetDevTokenAbiQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetDevTokenAbiQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetDevTokenAbiQuery(baseOptions?: Apollo.QueryHookOptions<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>(GetDevTokenAbiDocument, options);
      }
export function useGetDevTokenAbiLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>(GetDevTokenAbiDocument, options);
        }
export function useGetDevTokenAbiSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>(GetDevTokenAbiDocument, options);
        }
export type GetDevTokenAbiQueryHookResult = ReturnType<typeof useGetDevTokenAbiQuery>;
export type GetDevTokenAbiLazyQueryHookResult = ReturnType<typeof useGetDevTokenAbiLazyQuery>;
export type GetDevTokenAbiSuspenseQueryHookResult = ReturnType<typeof useGetDevTokenAbiSuspenseQuery>;
export type GetDevTokenAbiQueryResult = Apollo.QueryResult<GetDevTokenAbiQuery, GetDevTokenAbiQueryVariables>;
